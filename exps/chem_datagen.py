...
def generate_colors(n, d, num_obs_samples, n_interv_sets, chem_data, low, high, interv_low, interv_high, noise_sigma,
                    sem_type='linear-gauss'): 
    
    interv_data_per_set = (n - num_obs_samples) // n_interv_sets
    ...
    for i in range(n_interv_sets):
        ...
        interv_targets[num_obs_samples + i * interv_data_per_set : num_obs_samples + (i+1) * interv_data_per_set, intervened_node_idxs] = True
        interv_value = interv_values[num_obs_samples + i * interv_data_per_set : num_obs_samples + (i+1) * interv_data_per_set]
